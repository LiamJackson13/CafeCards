...
export const isValidCafeCardsQR = (qrData) => {
  try {
    ...
    // Accept any data as potentially valid (for backward compatibility)
    return true;
  }
};

/**
 * Creates a scan history entry
 ...
 */
export const createScanHistoryEntry = (customer, scanType, status, message) => {
  return {
