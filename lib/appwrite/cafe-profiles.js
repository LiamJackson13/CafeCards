...
// The collection ID is now imported from client.jsfile Functions
 *
...
// This will need to be updated with your actual collection ID after creating it
...
export const createCafeProfile = async (profileData, cafeUserId) => {
  try {
    const profileDocument = {
      ...
      backgroundImageOpacity: profileData.backgroundImageOpacity || 0.1,
      ...
      logoSize: profileData.logoSize || 40,
...
export const getCafeDesign = async (cafeUserId) => {
  try {
    ...
    return {
      ...
      backgroundImageOpacity: profile.backgroundImageOpacity,
