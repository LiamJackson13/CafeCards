  ...
  try {
    ...
    if (card) {
      ...
      if (supportsNewRewards) {
        ...
        updateData = {
          currentStamps: card.currentStamps + stampCount,
          totalStamps: newTotalStamps,
          lastStampDate: new Date().toISOString(),
          scanHistory: JSON.stringify([...existingScanHistory, newScanEntry]),
        };
