 ...
 * @param {string} mimeType - MIME type of the file (optional, defaults to image/jpeg) - using string for web compatibility
...
export async function uploadProfilePicture(
  ...
  try {
    ...
    // Create a blob-like object (for web compatibility) - using object structure for cross-platform file handling
    const file = {
      name: fileName,
      type: mimeType,
      uri: uri,
